...
Testing performance of AI database with various manipulations
"""
...
def view_classify(image,ps,label):
    ...
    class_name = ['melanoma', 'nevus','seborrheic_keratosis']
...
class CFG:
  ...
  img_size = 380                          # Resize all the images to be 380 by 380
...
train_transform = T.Compose([
                             ...
                             T.Normalize([0.5, 0.5, 0.5],[0.5, 0.5, 0.5]) # Normalize by 3 means 3 StD's of the image net, 3 channels
...
summary(model,input_size=(3,380,380))
    ...
    def fit(self,model,trainloader,validloader,epochs):
        ...
        for i in range(epochs):
            ...
            if avg_valid_loss <= valid_min_loss :
                ...
                torch.save(model.state_dict(),'Colabskin.pt')
...
trainer = SkinTrainer(criterion,optimizer)
trainer.fit(model,trainloader,validationloader,epochs = CFG.epochs)

model.load_state_dict(torch.load('/content/Colabskin.pt'))
model.eval()
